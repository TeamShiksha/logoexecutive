...
const validEnv = {
  ...
  BUCKET_NAME: "logoexecutive-dev-test-207783282532-ap-northwest-1",
  ACCESS_KEY: "GH67BTYLTNVVQEC6",
  SECRET_ACCESS_KEY: "Z1Ydwv8gcywVpcwJGYWy3cDEYUOlFoiI6Aw0E",
  JWT_SECRET: "my_secret",
  FIREBASE_ADMINSDK_ID: "cf456v9",
...
describe("Env Schema Validation", () => {
  ...
  it("should return error message if BASE_URL is not a valid URI", () => {
    ...
    expect(result.error.message).toMatch(/\"BASE_URL\" must be a valid uri/gi);
  });
  ...
  it("should validate with extended schema", () => {
    ...
    expect(result).toHaveProperty("error");
    expect(result.error.message).toMatch(/\"BUCKET_REGION\" is required/gi);
  });
