...
describe('About Component', () => {
  ...
  it('renders all sections with correct headings and paragraphs', () => {
    ...
    const journeyParagraph = screen.getByText(/LogoExecutive started its journey/i);
    ...
    const purposeParagraph = screen.getByText(/At LogoExecutive, our purpose is clear/i);
    ...
    const teamParagraph = screen.getByText(/Behind our exceptional services lies a team/i);
    ...
    const offeringsParagraph = screen.getByText(/At LogoExecutive, we offer a comprehensive range of services/i);
